...
public class BoardTextViewTest {
  ...
  /**
   * Test whether the BoardTextView could display normally in the empty board or
   * board that has some ships.
   */
  @Test
  ...
  void test_display_two_boards() {
    String myView = "  0|1|2|3\n" + "A  | | |d A\n" + "B  | | |d B\n" + "C  | | |d C\n" + "D  | | |  D\n" + "  0|1|2|3\n";
    String enemyView = "  0|1|2|3\n" + "A  | | |  A\n" + "B  |s|s|  B\n" + "C  | | |  C\n" + "D  | | |  D\n" + "  0|1|2|3\n";
    Board<Character> b1 = new BattleShipBoard(4, 4, 'X');
    Board<Character> b2 = new BattleShipBoard(4, 4, 'X');
    V1ShipFactory f = new V1ShipFactory();
